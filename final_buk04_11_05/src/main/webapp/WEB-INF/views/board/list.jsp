      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
          <h2 class="my-3 py-3 shadow-sm bg-light text-center">
            <mark class="sky fw-bold">여행정보공유</mark>
          </h2>
        </div>
        <div class="col-lg-8 col-md-10 col-sm-12">
    ...
    <script>
      ...
      titles.forEach(function (title) {
        title.addEventListener("click", function () {
          ...
          location.href = "${root}/board?action=detail&articleno=" + this.getAttribute("data-no") + "&pgno=${navigation.currentPage}"
          +"&key=${param.key}&word=${param.word}";
        });
      });

      document.querySelector("#btn-mv-register").addEventListener("click", function () {
        location.href = "${root}/board?action=mvregist";
      });
