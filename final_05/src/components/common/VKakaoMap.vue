  ...
  for (let i = 0; i < positions.value.length; i++) {
    ...
    kakao.maps.event.addListener(markers.value[i], "click", function () {
      ...
      var content =
        ...
        `   <a href="https://search.naver.com/search.naver?&query=${positions.value[i].title}" class="text-white bg-green-600 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">` +
        `       Read more` +
      ...
      div1.setAttribute(
        "class",
        "custom-overlay z-100 bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700"
      );
